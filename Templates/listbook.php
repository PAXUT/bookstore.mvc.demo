...
<html lang="en">
  ...
  />
  <link rel="stylesheet" href="Templates/bookwed/themify-icons/themify-icons.css">
  <link
    rel="stylesheet"
          ...
          <div class="col-lg-9">
            <div>
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="index.php?task=addbook"
                    >Thêm sách</a
                  >
                </li>
              </ul>
                   ...
                   <?php
                                while ($row = mysqli_fetch_assoc($listbook)){ ?>
                                    <tr>
                                        ...
                                        <td><a class="text-danger" href="index.php?task=updatebook&idbook=<?php echo $row['id_book'] ?>"><i class="ti-settings"></i></a></td>
                                        <td><a class="text-danger" onclick="return confirm('Are you want to delete?')" href="index.php?task=deletebook&idbook=<?php echo $row['id_book'] ?>"><i class="bi bi-trash"></i></a></td>
                                    </tr>
                                <?php }; ?>
                  </table>
                </div>
              </div>
              <div id="addbook" class="container tab-pane ">
                <!--Them thanh vien-->
